...
% Battery
plane.batteryType2 = 'Thunder_LiPo_4400';
% plane.batteryType2 = 'Thunder_LiPo_3300';
...
% Battery
plane.batteryType3 = 'Thunder_LiPo_3300'; 
...
% Payload
plane.nPayloads3 = 3;
plane.m3DropsondeMass = 0.1; % [kg]
%plane.DApayload3 = (1.17*(plane.lengthPayload3*0.0214))/plane.S; % update if Dropsondes internal/external
